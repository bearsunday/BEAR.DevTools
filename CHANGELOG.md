...
### Fixed
- HttpResource shell command breaks with special characters in payloads (#21)

### Changed
- Replace shell-based `exec()` with PHP native cURL extension for HTTP requests
- Add `ext-curl` to composer.json requirements
